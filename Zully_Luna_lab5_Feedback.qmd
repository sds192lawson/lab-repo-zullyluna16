...
##TA Feedback: This looks woundrous!
...
sqf_2011|>
  ...
  arrange(desc(stops))
##TA Feedback: This looks marvelous just remeber to add na.rm=TRUE to each part of your summarized next time. +2.5
##Total for Q1-Q9: 26.5
```
