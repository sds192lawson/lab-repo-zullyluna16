...
la_map|>
  ...
  addPolygons(data = census_counties, weight = 2, color = "Blues", fillColor = ~pal_bin_census_county_pop(percent_black), fillOpacity = 0.5)|>
  
  addLegend(data = census_counties, title = "Population Black Residents- County", pal = pal_bin_census_county_pop, value = ~percent_black)|>
  
  addPolygons(data = census_tracts, weight = 1, color = "grey", fillColor = ~pal_bin_census_tracts_pop(percent_black), fillOpacity = 0.2)|>
  
  addLegend(data = census_tracts, title = "Popultion Black Residents- Tracts", pal = pal_bin_census_tracts_pop, value = ~percent_black)
