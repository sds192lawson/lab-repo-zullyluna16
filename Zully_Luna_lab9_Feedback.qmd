...
la_map|>
  ...
  addCircleMarkers(data = tri_la_2023,
                   ...
                   fillColor = "white",
                   fillOpacity = 5)
##TA Feedback: This looks beautiful! +4 pts
...
##TA Feedback: This looks fantastic but try using unique next time! +2.5
##Like this: pal_fact <- colorFactor(palette = "Set2",
                        #domain = unique(tri_la_2023$X23..INDUSTRY.SECTOR))
...
pal_quant <- colorQuantile(palette ="YlOrRd",
                    domain = tri_la_2023$X107..TOTAL.RELEASES,
                    n = 4)
##TA Feedback: This looks terrific! +3
...
##TA Feedback: Which one represents the distribution best?? +1.5
