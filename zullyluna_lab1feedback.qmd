...
#TA Feedback: +3 for using unique and the correct key
#Total for Q1: 6 points
```
...
##TA Feedback: I would like a little more information about what schools are included. +4
##Total for Q1-Q2: 10 points
...
typeof(scorecard$highdeg) #ordinal, TA Feedback: I would consider this more discrete than ordinal -0.5
typeof(scorecard$ugds) #discrete
typeof(scorecard$adm_rate) #continuous
##Total for Q1-Q3: 14.5
```
...
ggplot(scorecard, aes(x = admcon7_text)) +
  geom_bar()
##TA Feedback: your graph looks great +5
##Total for Q1-Q4: 19.5 points
```
...
##TA Feedback: -2 for incorrect comment, there are lots of na variables becuase costt4_a is only calculated for academic year institutions, while costt4_p is calculated for program year institutions. 
##Total for Q1-Q5: 22.5
```
...
##TA Feedback:This fully adresses the bias question but not the social consequences question +2.5
##Total for Q1-Q6: 25/30 or 83.33%
