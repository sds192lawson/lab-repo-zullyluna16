...
##TA Feedback: This looks awesome nice job! +3
##Total for Q1: 3 pts
```
...
##TA Feedback: This looks great, remember you can also use map_int to convert to interger! +3 
...
##TA Feedback: This look beautiful, you can specify the number of rows the head function prints like this: 
#head(10) <-- Prints the first 10 rows
...
payments_calendar<- function(doctor_id, doctor_name){
  doctor_id_payment<- open_payments|>
    filter(Covered_Recipient_NPI == doctor_id)
  ggplot(doctor_id_payment, aes(x = Date_of_Payment, y = Total_Amount_of_Payment_USDollars))+ ##TA Feedback: Use summarize here instead:  summarize(specialty = first(Covered_Recipient_Specialty_1)) |>
    #pull()
...
##TA Feedback: Then bring in your geom_jitter function like this: 
#open_payments |>
    #filter(Covered_Recipient_NPI == doctor_id) |>
...
##TA Feedback: Marvelous job on the map part though! +1.5
##Total for Q1-Q9: 25.5
```
...
##TA Feedback: I don't think you need this plot! +1.5

 ##TA Feedback: Correct plotting of the data set! 
  #map_df(top_10_doctors_ids, calculate_manufacturer_payments) |>
  #ggplot(aes(x = Applicable_Manufacturer_or_Applicable_GPO_Making_Payment_Name, 
