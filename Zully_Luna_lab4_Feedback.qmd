...
hmda_ms_2024 |>
  ...
  labs(title = "Home Mortgage Disclosure Act Applications, Mississippi, 2024",
       ...
       y = "[Count of loans]") +
  theme_minimal()
##TA Feedback: This graph looks good except for one small labeling thing, the y-variable for this is the count of applications not the count of granted loans. -0.5 for labeling mistake
##Total for Q1: 2 pts 
```
:::
- how many loans
...
##TA Feedback: It looks like you skipped this question becuase this is not the answer to question 5. I would read the directions again here. -2.5 for completley incorrect answer
...
hmda_ms_2024 |>
  ...
  guides(fill=guide_legend(nrow=4))
##TA Feedback: This graph looks tremendous but remember to add a a label for your fill variable next time! -1 for missing lablel.
##Total for Q1-6: 9.5 pts
```
...
hmda_denial_by_race <-
  ...
  theme_minimal() +
  coord_flip()
##TA Feedback: Despite your confusion this graph looks marvelous! +2.5. 
##Total for Q1-8: 14.5 pts
```
...
hmda_denial_by_sex<- 
  ...
  theme_minimal() +
  coord_flip()
##TA Feedback: This graph looks terrific! +2.5 You do no need the group by or summarize before your graph for this question though.
...
hmda_ms_2024 |>
  ...
  theme_minimal()+
  coord_flip()
##TA Feedback: This graph looks extraoridinary! +2.5 again no need for the group by or summarize for this question.
##Total for Q1-10: 19.5 pts
```
...
hmda_ms_2024 |>
  ...
  ##TA Feedback: This graph looks amazing! +2.5 pts
  ##Total for Q1-11: 22 pts
```
...
hmda_ms_2024 |>
  ...
  theme_minimal() 
  ##TA Feeback: This graph looks beautiful! +2.5
  ##Total for Q1-12: 24.5 pts
```
...
##TA Grading: Final Score: 24.5/30 or 81.66%
:::
