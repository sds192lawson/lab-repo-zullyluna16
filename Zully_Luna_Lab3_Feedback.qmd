...
nbi_hampshire |>
  ...
  theme_minimal()
  ##TA Feedback: I would suggest using different columns or variables for color, and size a your y-axis that way you can show more on just one graph! +3
...
nbi_hampshire |>
  ...
  labs(title = "Highway Bridge Conditions, Massachusetts, 2024",
       ...
       col = "Route Prefix") +
  theme_minimal()
##TA Feedback: Try adding a specific color to your scale_color_brewer function by adding palette=[color set you would like to use], also usually add ons like scale_color_brewer go at the end of the graph calls. +3
